...
const Workout = () => {
  ...
  const updateWorkoutSection = () => {
    const sectionClass = `${currentGender}-${currentLevel}`;
    const sections = document.querySelectorAll(".Workout-main-content-workout");
    sections.forEach((section) => {
      section.classList.remove("active");
      if (section.id === sectionClass) {
  ...
  const handleGenderToggle = () => {
    ...
    genderToggle.classList.toggle("male");
    genderToggle.classList.toggle("female");
    genderToggle.classList.add("ripple");
    setTimeout(() => genderToggle.classList.remove("ripple"), 300);
    setCurrentGender(
      genderToggle.classList.contains("male") ? "male" : "female"
    );
  };

  const handleLevelToggle = () => {
    const levelToggle = document.getElementById("levelToggle");
    levelToggle.classList.toggle("normal");
    levelToggle.classList.toggle("advanced");
    levelToggle.classList.add("ripple");
    setTimeout(() => levelToggle.classList.remove("ripple"), 300);
    setCurrentLevel(
      levelToggle.classList.contains("normal") ? "normal" : "advanced"
    );
  };

  useEffect(() => {
    updateWorkoutSection();
    document.getElementById("genderStatus").textContent = `${currentGender.charAt(0).toUpperCase() + currentGender.slice(1)
      } selected`;
    document.getElementById("levelStatus").textContent = `${currentLevel.charAt(0).toUpperCase() + currentLevel.slice(1)
      } selected`;
  }, [currentGender, currentLevel]);

  return (
    <>
      {/* Control Panel */}
      <div className="Workout-control-panel">
        <div className="Workout-toggles-container">
          {/* Gender Toggle */}
          <div className="Workout-toggle-section">
            <span className="Workout-toggle-label">Select Gender:</span>
            <div
              className="Workout-toggle-switch male"
              id="genderToggle"
              onClick={handleGenderToggle}
            >
              <span className="Workout-toggle-option male">Male</span>
              <span className="Workout-toggle-option female">Female</span>
              <div className="Workout-toggle-slider"></div>
            </div>
            <div className="Workout-toggle-status">
              <span className="Workout-status-dot"></span>
              <span id="genderStatus">Male selected</span>
            </div>
          </div>
          {/* Level Toggle */}
          <div className="Workout-toggle-section">
            <span className="Workout-toggle-label">Select Level:</span>
            <div
              className="Workout-toggle-switch normal"
              id="levelToggle"
              onClick={handleLevelToggle}
            >
              <span className="Workout-toggle-option normal">Normal</span>
              <span className="Workout-toggle-option advanced">Advanced</span>
              <div className="Workout-toggle-slider"></div>
            </div>
            <div className="Workout-toggle-status">
              <span className="Workout-status-dot"></span>
              <span id="levelStatus">Normal selected</span>
            </div>
          </div>
        </div>
      </div>
      ...
      {/*================================= Male Normal Workout =================================*/}
      <div
        className="Workout-main-content-workout male-normal"
        id="male-normal"
      >
        <div className="Workout-workout-info">
          <h2>Male Normal Workout</h2>
          <div className="Workout-svg_container">
            {/* First Svg */}
            <div className="Workout-svg_op">
              <svg
              ...
              >
                ...
                >
                  <Link to="/Male_Normal_Calves" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Male_Normal_Quads" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Male_Normal_Abdominals" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Male_Normal_Obliques" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Male_Normal_Hands" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Male_Normal_Forarms" target="_blank">
                    <path
                ...
                <g
                  ...
                  id="biceps"
                >
                  <Link to="/Male_Normal_Biceps" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Male_Normal_Front_Shoulder" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Male_Normal_Chest" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Male_Normal_Traps" target="_blank">
                    <path
            ...
            <div className="Workout-svg_op">
              ...
              >
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Male_Normal_Hamstrings" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Male_Normal_Glutes" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Male_Normal_Triceps" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Male_Normal_Lats" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Male_Normal_Lower_Back" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Male_Normal_Middle-Trapes" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Male_Normal_Rear_Shoulder" target="_blank">
                    <path
      ...
      {/*================================= Male Advanced Workout =================================*/}
      <div
        className="Workout-main-content-workout male-advanced"
        id="male-advanced"
      >
        <div className="Workout-workout-info">
          <h2>Male Advanced Workout (Coming Soon.....)</h2>
          <div className="Workout-svg_container">
            {/* First Svg */}
            <div className="Workout-svg_op"></div>
            {/* Second Svg */}
            <div className="Workout-svg_op"></div>
          </div>
        </div>
      ...
      {/*================================= Female Normal Workout =================================*/}
      <div
        className="Workout-main-content-workout female-normal"
        id="female-normal"
      >
        <div className="Workout-workout-info">
          <h2>Female Normal Workout</h2>
          <div className="Workout-svg_container">
            {/* First Svg */}
            <div className="Workout-svg_op">
              <svg
              ...
              >
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Female_Normal_Calves" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Female_Normal_Quads" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Female_Normal_Obliques" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Female_Normal_Abdominals" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Female_Normal_Hands" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Female_Normal_ForArms" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Female_Normal_Biceps" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Female_Normal_Chest" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Female_Normal_Front_Shoulder" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Female_Normal_Traps" target="_blank">
                    <path
            ...
            <div className="Workout-svg_op">
              ...
              >
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Female_Normal_Lowerback" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Female_Normal_Triceps" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Female_Normal_Hamstrings" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Female_Normal_Glutes" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Female_Normal_Lats" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Female_Normal_Rear_shoulders" target="_blank">
                    <path
                ...
                <g
                  ...
                  class="bodymap text-mw-gray active:text-mw-red-700 lg:hover:text-mw-red-100"
                >
                  <Link to="/Female_Normal_Traps_middle" target="_blank">
                    <path
      ...
      {/* Female Advanced Workout */}

      <div
        className="Workout-main-content-workout female-advanced"
        id="female-advanced"
      >
        <div className="Workout-workout-info">
          <h2>Female Advanced Workout (Coming Soon.....)</h2>
          <div className="Workout-svg_container">
            {/* First Svg */}
            <div className="Workout-svg_op"></div>
            {/* Second Svg */}

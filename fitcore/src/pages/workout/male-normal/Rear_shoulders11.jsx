...
import video81 from "./videos/81rear-shoulder.mp4";
import video82 from "./videos/82rear-shoulder.mp4";
import video83 from "./videos/83rear-shoulder.mp4";
import video84 from "./videos/84rear-shoulder.mp4";
import video85 from "./videos/85rear-shoulder.mp4";
import video86 from "./videos/86rear-shoulder.mp4";
import video87 from "./videos/87rear-shoulder.mp4";
import video88 from "./videos/88rear-shoulder.mp4";
      ...
      <div className="main_content">
        ...
        <div className="list">
          ...
          <ol className="workout-steps">
            <li>
              <span>
                Hold the dumbbells with a neutral grip (thumbs facing the
                ceiling).
              </span>
            </li>
            <li>
              <span>
                Retract your shoulder blades and shoulder joint until the band
                taps your chest.
              </span>
            </li>
          </ol>
